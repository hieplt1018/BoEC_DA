...
<%@page import="session.ClothesFacadeLocal"%>
<%@page import="session.ClothesFacade"%>
<%@page import="java.util.ArrayList"%>
<%@page import="entity.Clothes"%>
<%
    ClothesFacadeLocal clothesFacadeLocal = new ClothesFacade();
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-7 text-white">
                        ...
                        <a href="${pageContext.request.contextPath}/page/product.jsp?ID=A2871" class="site-btn sb-line">DISCOVER</a>
                        <a href="${pageContext.request.contextPath}/GioHangServlet?command=insert&ID=A2871&cartID=<%=System.currentTimeMillis()%>" class="site-btn sb-white">ADD TO CART</a>
                    </div>
                </div>
                <div class="offer-card text-white">
                    <span>from</span>
        ...
        <div class="product-slider owl-carousel">
            ...
            <div class="product-item">
                <div class="pi-pic">
                    ...
                    <div class="pi-links">
                        <a href="${pageContext.request.contextPath}/GioHangServlet?command=insert&ID=<%=clothes.getId()%>&cartID=<%=System.currentTimeMillis()%>" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
                        <a href="${pageContext.request.contextPath}/page/product.jsp?ID=<%=clothes.getId() %>" class="wishlist-btn"><i class="flaticon-heart"></i></a>
                    </div>
                </div>
                <div class="pi-text">
...
<section class="product-filter-section">
    <div class="container">
        ...
        <div class="row">
            <%
                List<Clothes> list = clothesDaoImpl.getAllClothesByCategory(3);
                for (int i = 8; i > 0; i--) {
