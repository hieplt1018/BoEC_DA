                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-5">
                            <form class="header-search-form" action="${pageContext.request.contextPath}/SearchNameServlet"  method="post">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="user-panel">
                                ...
                                %>
                                <span id="welcome" style="margin-right: 3%">Welcome <%=username %></span>
