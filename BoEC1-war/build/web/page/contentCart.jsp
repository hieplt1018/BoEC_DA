                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="product-col">
                                        ...
                                        <div class="pc-title">
                                            <h4><a href="${pageContext.request.contextPath}/page/product.jsp?ID=<%=clothes.getId()%>"><%=ds.getValue().getName()%></h4>
                                    ...
                                    <td class="quy-col">
                                        <div class="quantity">
                                            <div class="pro-qty">
                                                ...
                                                %>
                                                <a class="dec qtybtn" href="${pageContext.request.contextPath}/GioHangServlet?command=sub&ID=<%=ds.getValue().getId()%>&cartID=<%=cartID %>">-</a>
                                                <input type="text" value="<%=quantity.get(key) %>">
                                                <a class="inc qtybtn" href="${pageContext.request.contextPath}/GioHangServlet?command=insert&ID=<%=ds.getValue().getId()%>&cartID=<%=cartID %>">+</a>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="cart_delete">
                                        <a class="cart_quantity_delete" href="${pageContext.request.contextPath}/GioHangServlet?command=remove&ID=<%=ds.getValue().getId()%>&cartID=<%=cartID %>"><i class="fa fa-times"></i></a>
                                    </td>
                                </tr>
                                <%
