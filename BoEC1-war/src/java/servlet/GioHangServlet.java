...
public class GioHangServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String msp = String.valueOf(request.getParameter("ID"));
        ...
        try {
            ...
            System.out.println("ClothesID: " + clothes.getId());
            ...
            switch (command) {
                case "insert":
                    ...
                    if (listBuy.indexOf(idBuy) == -1) {
                        cart.insertToCart(Long.parseLong(clothes.getId(), 36), clothes);
                        listBuy.add(idBuy);
                    }
                    url = "/page/cart.jsp";
                    break;
                ...
                case "sub":
                    ...
                    if (listBuy.indexOf(idBuy) == -1) {
                        cart.subToCart(Long.parseLong(clothes.getId(), 36), clothes);
                        listBuy.add(idBuy);
                    }
                    url = "/page/cart.jsp";
                    break;
                ...
                case "remove":
                    cart.removeToCart(Long.parseLong(clothes.getId(), 36));
                    url = "/page/cart.jsp";
                    break;
