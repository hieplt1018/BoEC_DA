...
<%@page import="entity.ClothesCatergory"%>
...
<%
    ...
    String ten_danh_muc = "";
    int ma_danh_muc = clothes.getClothesCatergoryID();
    if (ma_danh_muc == 1) {
        ten_danh_muc = "Skirt";
...
<section class="product-section">
    <div class="container">
        <div class="back-link">
            <a href="${pageContext.request.contextPath}/page/category.jsp?category=<%=clothes.getClothesCatergoryID()%>"> &lt;&lt; BACK TO CATEGORY</a>
        </div>
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6 product-details">
                ...
                <a href="${pageContext.request.contextPath}/GioHangServlet?command=insert&ID=<%=clothes.getId()%>&cartID=<%=System.currentTimeMillis()%>" class="site-btn">ADD TO CART</a>
